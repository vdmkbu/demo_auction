...
@section('title', 'Лоты')
@section('headline', 'Добавить лот')

@section('content_inner')
    <div class="ibox-content">
    <form enctype='multipart/form-data' class="form-horizontal" method='post' action='{{ route('lot.store') }}'>
        @csrf
        <div class="form-group{{ $errors->has('company_id') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
                <select class="form-control m-b" name="company_id">
                    ...
                    <option value="{{ $company->id }}">{{ $company->name }}, <small>ИНН: {{ $company->INN }}</small></option>
                    @endforeach
            ...
            <div class="col-sm-10">
                ...
                <label class="checkbox-inline">
                    <div class="i-checks"><label>
                            <input checked="checked" type="radio" value="1" name="operation_type"> <i></i> Покупка </label>
                    </div>
                </label>
                <label class="checkbox-inline">
                    <div class="i-checks"><label>
                            <input type="radio" value="2" name="operation_type"> <i></i> Продажа </label>
                    </div>
                </label>
        ...
        <div class="form-group{{ $errors->has('nomenclature') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10">
                <textarea maxlength="300" name="nomenclature" required="required" class="form-control"></textarea>
            ...
            <div class="col-sm-10">
                ...
                <label class="checkbox-inline">
                    <div class="i-checks-nds">
                        <label>
                            <input checked="checked" class="lot_nds" type="radio" data-value="0" value="0" name="NDS"> <i></i> Без НДС
                        </label>
                    </div>
                </label>
                ...
                <label class="checkbox-inline">
                    <div class="i-checks-nds">
                        <label>
                            <input class="lot_nds" type="radio" data-value="10" value="10" name="NDS"> <i></i> 10%
                        </label>
                    </div>
                </label>
                ...
                <label class="checkbox-inline">
                    <div class="i-checks-nds">
                        <label>
                            <input class="lot_nds" type="radio" data-value="18" value="18" name="NDS"> <i></i> 18%
                        </label>
                    </div>
                </label>
                @if ($errors->has('NDS'))
        ...
        <div class="form-group{{ $errors->has('sum') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10"><input type="number" max="99999999" required="required" name="sum" class="form-control lot_sum">
                @if ($errors->has('sum'))
        ...
        <div class="form-group{{ $errors->has('fee') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-10"><input required="required" type="number" step="0.1" min="2" max="99" name="fee" class="form-control fee">
                @if ($errors->has('fee'))
